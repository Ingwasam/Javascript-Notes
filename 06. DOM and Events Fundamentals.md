...
**DOM** - Document Object Model: Structured Representation of Html Documents. Allows Javascript to Access Html Elements and Styles to Manipulate Them. Dom Changes text, HTML attributes, and even CSS styles. DOM part of API that browser implement and we can access that from JavaScript code.
...
- **Event Listener** - Now, an event is something that happens on the page. For example, a mouse click, or a mouse moving, or a key press, based on that we can do something.
